...
ENV MINIAPP_GITHUB_EXTRA_CASES_FILE=/app/template-data/boLandingPromptCases.ts
...
COPY ["ima ima queencard/frontend/src/data/boLandingPromptCases.ts", "./template-data/boLandingPromptCases.ts"]
COPY ["ima ima queencard/frontend/public/xhs-cases", "./public/xhs-cases"]
COPY ["ima ima queencard/frontend/public/landing", "./public/landing"]
